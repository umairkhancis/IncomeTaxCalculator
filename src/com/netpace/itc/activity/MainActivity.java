	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		calcTaxButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				Intent intent = new Intent(MainActivity.this, CalculateTaxActivity.class);
		...
		calcImpactButton.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View view) {
				Intent intent = new Intent(MainActivity.this, CalculateImpactActivity.class);
				startActivity(intent);
			}
		});
		...
		howtosaveButton.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				Intent intent = new Intent(MainActivity.this, HowToSaveActivity.class);
				startActivity(intent);
			}
		});
		...
		plantosaveButton.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				Intent intent = new Intent(MainActivity.this, PlanToSaveActivity.class);
				startActivity(intent);
			}
		});		
	}
